...
export function Footer() {
  return (
    <footer className="bg-white/80 backdrop-blur-xl border-t border-gray-100 mt-12">
        ...
        >
          ...
          <div className="flex items-center space-x-4">
            <a
              ...
              className="group flex items-center space-x-2 text-sm font-medium text-gray-700 hover:text-blue-600 transition-colors"
            >
              <span>Portfolio</span>
